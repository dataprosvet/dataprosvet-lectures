...
Мы завершаем курс двумя идеями. Нормальное распределение даёт важнейшую непрерывную модель, а предельные теоремы объясняют, почему средние и суммы во многих задачах ведут себя устойчиво и приближённо нормально.

...
После подтверждённого `pull` новая редакция лекции 1 принимается как содержательная база коллеги. В рамках этого change разрешено только привести три файла лекции 1 к читаемому Markdown: убрать оформление формул как цитат, нормализовать пробелы и математические блоки, а также заключить все формулы, математические обозначения, переменные, множества и операции в корректные LaTeX-разделители `$…$` или `$$…$$`. Обычный текст, числа без математической роли и служебные фрагменты Markdown не должны механически превращаться в формулы. Добавление, удаление и переформулирование учебного содержания запрещено. Сохранность проверяется сравнением нормализованного текстово-математического содержания до и после форматирования и отдельным аудитом оставшихся математических токенов вне LaTeX.

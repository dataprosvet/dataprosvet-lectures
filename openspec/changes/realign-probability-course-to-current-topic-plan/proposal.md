...
- Оформить в трёх версиях лекции 1 все математические формулы, обозначения, множества, операции и переменные как LaTeX-фрагменты `$…$` или `$$…$$`, не меняя их математический смысл и окружающее учебное содержание.

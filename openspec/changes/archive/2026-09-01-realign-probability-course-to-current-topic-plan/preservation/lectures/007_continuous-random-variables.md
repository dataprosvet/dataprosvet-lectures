...
**Перед началом:** нужны функция распределения, $E[X]$, $\operatorname{Var}(X)$ и базовые навыки интегрирования.
...
\qquad \sigma(X)=\sqrt{\operatorname{Var}(X)}.
$$
...
$$
\operatorname{Var}(X)=\frac35-\frac9{16}=\frac3{80},
...
$$
E[T]=\frac1\lambda,
\qquad \operatorname{Var}(T)=\frac1{\lambda^2}.
$$
...
- [Семинар 14. Функция распределения и плотность](../seminars/114_continuous-cdf-density.md)
- [Семинар 15. Характеристики, равномерный и показательный законы](../seminars/115_continuous-characteristics-uniform-exponential.md)

...
Markdown: до 262 144 байт. Изображения: только PNG/JPEG, до 5 000 000 байт, 4096×4096 и 16 млн пикселей; WebP не принимается. Внешние изображения и raw HTML запрещены.
